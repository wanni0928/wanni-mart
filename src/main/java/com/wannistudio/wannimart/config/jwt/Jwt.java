...
public class Jwt {
  ...
  public String newToken(Claims claims) {
    ...
    builder.withClaim("account", claims.account);
  ...
  static public class Claims {
    ...
    public static Claims of(long userKey, String name, String account, Email email, String[] roles) {
    ...
    long iat() {return iat != null ? iat.getTime() : -1;}
    long exp() {return exp != null ? exp.getTime() : -1;}
    void eraseIat() {iat = null;}
    void eraseExp() {exp = null;}
